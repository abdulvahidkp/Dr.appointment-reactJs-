...
function DrCardsComponent() {
  return (
    <div className="bg-gradient-to-r from-emerald-50 to-emerald-100">
      <div className="container max-w-screen-xl mx-auto">
        <div className="flex flex-col sm:flex-row">
          <div className="w-full sm:w-2/3">
            <div className="grid grid-cols-2 gap-3 min-h-screen place-items-center py-24 ">
              {/* start */}
              <div className="w-full p-4 lg:w-72 2xl:w-80 rounded-lg shadow-xl mt-20 scale-100 hover:scale-105 ease-in duration-200 bg-white">
                ...
                <div className="flex justify-between mt-3">
                  <span className="bg-teal-200 text-teal-800 text-xs px-2 inline-block rounded-full uppercase font-semibold tracking-wide">DENTIST</span>
                </div>
                <h4 className="mt-1 text-md md:text-xl font-semibold uppercase leading-tight truncate">Dr. Nirmal B S</h4>
                <div className="sm:mt-1">11 year exp</div>
                <div className="sm:mt-1">MBBS, MD, DM</div>
                <div className=" sm:mt-0 flex flex-col sm:flex-row sm:justify-between sm:items-center">
                  <div>
                    <p className="mt-3 hidden sm:block text-[#4f4c4a]">appolo clinics</p>
                  ...
                  <div className="-mt-2 sm:-mt-0 flex flex-row sm:flex-col items-end ">
                    <h2 className="font-semibold sm:font-bold mt-3 text-start sm:text-end">₹233</h2>
...
export default DrCardsComponent;
